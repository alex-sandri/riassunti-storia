...
L'ultimo anno di guerra fu particolarmente difficile per la Germania. La popolazione e l'esercito sapevano di avere perso.\
La monarchia dimostrava la sua debolezza e non era più in controllo della situazione. Intanto proseguiva la propaganda socialista: vennero creati dei *`consigli`* sul modello dei soviet russi dai soldati dell'esercito e dagli operai. Sembrava imminente una rivoluzione socialista.

Il `9 novembre 1918` venne proclamata la `repubblica` e due giorni dopo venne firmato l'armistizio con gli Anglo-Francesi.\
Vennero quindi indette le elezioni per formare un'Assemblea Costituente.

La preparazione a queste elezioni fece emergere le divisioni interne alla sinistra tedesca.\
La maggioranza del movimento socialista era il *Partito Socialdemocratico Tedesco* (`SPD`), che sosteneva posizioni riformiste e democratiche. Questo partito riteneva i *consigli degli operai e dei soldati* un'istituzione provvisoria, da smantellare quando la democrazia fosse stata pienamente operativa. Inoltre voleva evitare ulteriori lotte cercando dei compromessi cone le vecchie classi dirigenti.\
L'ala estrema del movimento socialista si divideva in:
- *Partito Socialdemocratico Indipendente* (`USPD`)
- `Lega di Spartaco`, inizialmente una corrente interna all'USPD, crearono alla fine del 1918 il *Partito Comunista Tedesco* (`KPD`)

Il dissenso sull'orientamento del governo e del Partito socialdemocratico portò i rivoluzionari in piazza. A `Berlino`, tra il `5` e il `13 gennaio 1919` gli spartachisti occuparono edifici pubblici e sedi di giornali, nel tentativo di boicottare le elezioni e rovesciare il governo.\
Il tentativo però fallì grazie all'intervento delle forze armate e dei *Freikorps* (corpi di volontari formati da militari reduci della guerra).

Alle elezioni per l'Assemblea Costituente, il `19 gennaio 1919`, furono le prime a suffragio universale e premiarono l'SPD con la maggioranza ma non assoluta. Venne creato così un governo di coalizione con il partito cattolico (*Zentrum*) e con i liberali democratici (DDP).\
Dalla cittadina di `Weimar` nel giro di un mese l'Assemblea diede al Paese la `Costituzione`. La Germania divenne quindi una *repubblica federale*:
- Potere legislativo: *Reichstag* (Parlamento)
- Potere di veto legislativo: *Reichsrat* (Consiglio federale)
- Potere esecutivo: governo presieduto da un *cancelliere*
- Il *presidente della Repubblica* veniva eletto ogni sette anni e disponeva di ampi poteri
...
Tra il 1930 e il 1932 la popolazione tedesca votò ben tre volte, nessun governo durava molto. Nello stesso periodo si rafforzavano invece sempre più i nazisti.\
